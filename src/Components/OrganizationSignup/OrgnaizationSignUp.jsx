...
function OrganizationSignup() {
  ...
  const HandleSubmit=(e)=>{
    ...
    formData.append('account','recruiter')  
    formData.append("country", countryId);
    formData.append("city", city);
    console.log(formData)
    dispatch(adduser(formData))
    .then(res=> nevigate(`/login`))
        ...
        <div className="row  d-flex justify-content-center">
          <div className="col-lg-5 col-sm-12">
            ...
            <div className="col-lg-12">
              <div className="row d-flex justify-content-center">
                <div className="col-12 feild d-flex align-items-center ">
                  <h6 className="content">Company Name</h6>
                </div>
            ...
            <div className="col-lg-12">
              <div className="row d-flex justify-content-center">
                <div className="col-12 feild d-flex align-items-center ">
                  <h6 className="content">Type of Campany</h6>
                </div>
                <div className="col-12 input">
                  <input type="text" placeholder="Example: Educational, Software House " value={type} onChange={(e)=>setType(e.target.value)}  />
                </div>
              </div>
            </div>
            <div className="col-lg-12">
              <div className="row d-flex justify-content-center">
                <div className="col-12 feild d-flex align-items-center ">
                  <h6 className="content">Company Phone No</h6>
                </div>
                <div className="col-12 input">
            ...
            <div className="col-lg-12">
              <div className="row d-flex justify-content-center">
                <div className="col-12 feild d-flex align-items-center ">
                  <h6 className="content">Company Email</h6>
                </div>
                <div className="col-12 input">
